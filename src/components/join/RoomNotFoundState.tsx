...
export function RoomNotFoundState() {
  return (
    <div className="glass-card flex flex-col items-center gap-4 p-8 text-center">
      ...
      <div>
        <h1 className="text-lg text-balance font-bold text-brand-sand">החדר לא נמצא</h1>
        <p className="mt-1 text-sm text-pretty text-brand-sand/60">ייתכן שהקוד שגוי או שהחדר נמחק</p>
      </div>
