  ...
  return (
    <div className="flex items-start gap-3 rounded-2xl border border-brand-amber-500/30 bg-brand-amber-500/10 px-4 py-3">
      ...
      <div className="text-sm leading-relaxed">
        <p className="text-balance font-semibold text-brand-amber-300">
          הסכומים לא מסתדרים — כדאי לבדוק
        </p>
        <p className="mt-1 text-pretty text-brand-sand/70">
        ...
        <p className="mt-1 text-xs text-pretty text-brand-sand/50">
